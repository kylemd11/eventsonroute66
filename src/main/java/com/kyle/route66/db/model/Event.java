...
public class Event  implements java.io.Serializable {
    ...
    public Event(String username, String title, Date startDtg, Date endDtg, String city, String stateCd, String zipCode, String content, String summary, String eventTypeCd, Date createDtg, BigDecimal latitude, BigDecimal longitude) {
    ...
    public Event(String username, String title, Date startDtg, Date endDtg, String address1, String address2, String city, String stateCd, String zipCode, String content, String summary, String eventTypeCd, Date createDtg, BigDecimal latitude, BigDecimal longitude, Date updateDtg, boolean isNew, boolean allDay, String lockedBy, Date lockedDate) {
       this.username = username;
       this.title = title;
       this.startDtg = startDtg;
       this.endDtg = endDtg;
    ...
    @Column(name="lckd_by", nullable=false)
    ...
    @Temporal(TemporalType.TIMESTAMP)
    @Column(name="lckd_dtg", length=19)
	...
	public boolean isLocked() {
		if(this.lockedDate != null) {
			return new Date().before(DateUtils.addMinutes(this.lockedDate, 5));
		}
		else {
			return false;
		}
