...
import com.kyle.route66.util.Route66StatesComparator;
...
public class EventFilterBean {
	...
	public String applyDateFilter() {
		if (startDate == null || endDate == null) {
			FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_WARN, "Please fill in both dates.", "Please fill in both dates.");
			FacesContext.getCurrentInstance().addMessage("filterForm:startDateInput", msg);
		} else if (startDate != null && endDate != null) {
			if (startDate.after(endDate)) {
				FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_WARN, "Start Date must be before End Date.", "Start Date must be before End Date.");
				FacesContext.getCurrentInstance().addMessage("filterForm:startDateInput", msg);
			} else {
	...
	public String applyLocationFilter() {
		if (distance < 0) {
			FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_WARN, "You must pick a distance", "You must pick a distance");
	...
	public List<State> getStates() {
		...
		Collections.sort(states, new Route66StatesComparator());
